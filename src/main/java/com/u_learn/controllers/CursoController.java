...
public class CursoController {
	...
	public ResponseEntity registroCurso(@RequestBody CursoPOJO cursoPOJO) {
		...
		newCurc.setCalificacion(cursoPOJO.getCalificacion());
	...
	public ResponseEntity consultaTipoBicicleta() {
	...
	public ResponseEntity updateCurso(@RequestBody CursoPOJO cursoPOJO) {
		...
		existingCurso.setCalificacion(cursoPOJO.getCalificacion());
	...
	@PostMapping( value = {"curso/updatestars"})
	public ResponseEntity updateCursoStars(@RequestBody CursoStarsPOJO cursoStarsPOJO) {
		Curso existingCurso = cursoService.findCursoById(cursoStarsPOJO.getIdCurso());
		if (existingCurso == null) {
			return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
		}

		existingCurso.setCalificacion(cursoStarsPOJO.getCalificacion());
